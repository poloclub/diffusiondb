...
> **Warning**
> Although the Stable Diffusion model has an NSFW filter that automatically blurs user-generated NSFW images. However, this NSFW filter is not perfect, and DiffusionDB still contains some NSFW images. Therefore, we compute and share the NSFW scores for images and prompts using the state-of-the-art models. The distribution of these scores can be found in our [research paper](https://arxiv.org/abs/2210.14896).
